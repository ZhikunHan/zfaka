...
import org.hantiv.zfaka.dao.OrderMapper;
import org.hantiv.zfaka.dao.SerialNumberMapper;
...
import org.hantiv.zfaka.util.FormatUtil;
...
public class OrderServiceImpl implements OrderService, ErrorCode {
    ...
    String generateOrderID() {
        ...
        // 拼入日期
        sb.append(FormatUtil.format(new Date(), "yyyyMMdd"));
